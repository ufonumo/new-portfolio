            ...
            <section id="home" className="home">
                <div className="row ">
                    <div className="col-lg-7 white">
                        <sub className="sub">
                            Hi there <img src={vector} alt="love" />
                        </sub>
                        <p className="home_intro">
                            I am <b>Ufonabasi Umo,</b> Frontend Developer, with hands-on experience
                            creating web applications.
                        </p>
                        <a href="#projects">
                            <button className="btn mt-3 mb-5">View My Projects</button>
                        </a>
                    </div>
