                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 pt-4">
                        <div className='p-3 socials'>
                            <sub>Email</sub>
                            <p > <a className='ml-1' href="mailto:ufonumo@gmail.com "> ufonumo@gmail.com <img src={group} alt="link"/></a> </p>
                        </div>
                        <div className='pr-3 pl-3'>
                            <sub>Socials</sub>
                            <div className="socials">
                                <a className='ml-1' href="https://twitter.com/Ufonumo1"> Twitter</a>
