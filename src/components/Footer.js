...
import resume from "../assets/Ufonabasi-Umo Resume.pdf";
                    ...
                    <div className="col-lg-6  pt-4">
                        <div className="in_touch">
                            ...
                            <a href={resume} download={resume}>
                                <button className="btn m-3 ">Download CV</button>
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-6 pt-4">
                        <div className="p-3 socials">
                            ...
                            <p>
                                {" "}
                                <a className="ml-1 pt-1" href="mailto:ufonumo@gmail.com ">
                                    {" "}
                                    ufonumo@gmail.com <img src={group} alt="link" />
                                </a>{" "}
                            </p>
                        </div>
                        <div className="pr-3 pl-3 social_link">
                            ...
                            <div className="socials pt-1">
                                ...
                                <a href="https://www.linkedin.com/in/ufonumo"> LinkedIn</a>
                            </div>
                        </div>
                    </div>
                </div>
